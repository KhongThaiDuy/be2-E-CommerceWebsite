    ...
    <form>
        ...
        <div class="signup-group">
            <div class="inputGroup">
                <label for="signupName">Tên người dùng</label>
                <input type="text" id="signupName" />
            </div>
            <div class="inputGroup">
                <label for="signupEmail">Email<input type="email" id="signupEmail" />
            </div>
            <div class="inputGroup">
...
@section('styles')
    ...
    <style>
        /* Thêm một chút CSS để hiển thị phần đăng ký */
        .signup-group {
            margin-top: 20px;
        ...
        .signup-group button {
            width: 100%;
            padding: 10px;
            background-color: #5cb85c; /* Màu xanh lá cây cho nút đăng ký */
            color: white;
            border: none;
            border-radius: 5px;
            cursor: pointer;
